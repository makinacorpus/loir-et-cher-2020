window.SETTINGS = L.Util.extend({
    attributions: 'Tous acteurs de notre avenir - Loir et Cher 2020 - Makina Corpus',
    tileURL: './tiles/{z}/{x}/{y}.png',
    touchTileURL: './tiles/{z}/{x}/{y}.png',
    loirCherStyle: {fillOpacity: 0.2, fillColor: '#77309a', color: '#fff'},
    initialCenter: [[47.6,1.3], 12],
    clusterOptions: {showCoverageOnHover: false, disableClusteringAtZoom: 14, maxClusterRadius: 40},
    mapOptions: {maxZoom: 15, minZoom: 10, maxBounds: undefined},
...
( function () {
    ...
    CG41.initializeMap = function (divid) {
        var osm = L.tileLayer(SETTINGS.isTouchTable ? SETTINGS.touchTileURL : SETTINGS.tileURL);
        var borders = L.geoJson(borders41, {style: SETTINGS.loirCherStyle});
